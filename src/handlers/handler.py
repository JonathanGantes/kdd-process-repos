...
class Handler:
    ...
    def select_columns(self, df: DataFrame, select_columns : list):
        ...
        try:
            ...
            self.dbutils.notebook.exit("One o more of the columns that you are tryng to select does not exists")
        return new_df
    ...
    def drop_duplicated_columns(self, df: DataFrame, columns:list):
        ...
        try:
            ...
            self.dbutils.notebook.exit("One o more of the columns that you are tryng to drop druplicateds does not exists")
        return new_df
    ...
    def drop_nan_columns(self, df: DataFrame, columns:list ):
        ...
        try:
            ...
            self.dbutils.notebook.exit("One o more of the columns that you are tryng to drop NaN's does not exists")
        return new_df
    ...
    def integrate_json_or_parquet_datasets(self, resource_type: str, resource_id: list):
        ...
        try:
            ...
            self.dbutils.notebook.exit("Invalid Resource Id or Resource Does't Exists")
        return df
